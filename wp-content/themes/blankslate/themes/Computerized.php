<?php
/**
 * Template Name: Landing Page Computerized
...
<div id="site_container">
    ...
    <div id="alt_hero_area_computer"><?php if(USER_DEVICE == 'PHONE'){?><img src="/wp-content/themes/blankslate/images/hdr_computer_m.jpg" class="alt_hero_img"><?php } ?></div>
