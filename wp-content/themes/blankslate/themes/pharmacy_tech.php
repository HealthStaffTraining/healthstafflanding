<?php
/**
 * Template Name: Landing Page Pharmacy Tech
...
<div id="site_container">
    ...
    <div id="alt_hero_area_pharmacy"><?php if(USER_DEVICE == 'PHONE'){?><img src="/wp-content/themes/blankslate/images/hdr_pharmacy_tech_m.jpg" class="alt_hero_img"><?php } ?></div>
