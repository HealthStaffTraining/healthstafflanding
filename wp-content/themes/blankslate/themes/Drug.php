<?php
/**
 * Template Name: Landing Drug Rehab
...
<div id="site_container">
    ...
    <div id="alt_hero_area_drug"><?php if(USER_DEVICE == 'PHONE'){?><img src="/wp-content/themes/blankslate/images/hdr_drug_m.jpg" class="alt_hero_img"><?php } ?></div>
